...
(function (root, factory) {
  ...
  const JP_MAKERS_DIRECT = [
    ...
    { jp: ['山善', 'ヤマゼン'], en: ['YAMAZEN'] },
    { jp: ['コイズミ'], en: ['KOIZUMI'] },
    { jp: ['テスコム'], en: ['TESCOM'] },
    { jp: ['シロカ'], en: ['siroca'] },
    { jp: ['ドウシシャ'], en: [] },
    { jp: ['リズム(RHYTHM)', 'リズム(Rhythm)', 'リズム時計'], en: [] }, // 「リズム」単体は音楽系に誤反応するため正確形で照合
    { jp: ['フランフラン'], en: ['Francfranc'] }, // 英字は単語境界照合の en へ（部分一致回避）
    { jp: ['マクセル'], en: ['maxell'] },
    { jp: ['村田製作所'], en: ['Murata'] },
    { jp: ['ティーディーケイ'], en: ['TDK'] },
    { jp: ['任天堂'], en: ['Nintendo'] },
    ...
    // ===== 第4バッチ：アウトドア・スポーツ用品 =====
    { jp: ['スノーピーク'], en: ['Snow Peak'] },
    { jp: ['ロゴス', 'LOGOS'], en: [] }, // en の i フラグ照合は小文字 "logos"（ロゴの複数形）と衝突するため、大文字を区別できる jp 部分一致で照合
    { jp: ['キャプテンスタッグ'], en: ['Captain Stag'] },
    { jp: ['ユニフレーム'], en: ['UNIFLAME'] },
    { jp: ['オガワ'], en: ['ogawa'] },
    { jp: ['アライテント'], en: ['Arai Tent'] },
    { jp: ['ディーオーディー'], en: ['DOD'] }, // 英字「DOD」は en のみ（カナに入れると "DODGE" 等に部分一致し誤検出）
    { jp: ['シマノ'], en: ['Shimano'] },
    { jp: ['ダイワ'], en: ['Daiwa'] }, // en は i フラグ照合のため大文字 DAIWA もカバー
    { jp: ['ゼット'], en: ['Zett'] },
    ...
    { jp: ['キオクシア'], en: ['KIOXIA'] },
    { jp: ['マスプロ電工', 'マスプロ'], en: ['MASPRO'] },
    { jp: ['玄人志向'], en: [] },                 // 漢字固有。英字 KUROUTOSHIKOU は長く稀のため漢字のみ
    { jp: ['ノブナガラボ'], en: ['NOBUNAGA Labs'] },
    { jp: ['レコルト'], en: ['recolte'] },
    { jp: ['ビタントニオ'], en: ['Vitantonio'] },
    { jp: ['ラスタバナナ'], en: ['Rastabanana'] },
    { jp: ['イングレム'], en: ['Ingrem'] },
    { jp: ['DXアンテナ'], en: [] },               // 「DX」単体は頻出のため「DXアンテナ」カナで照合
    { jp: ['日本アンテナ'], en: [] },

    // ===== 第13バッチ：食品・飲料・調味料・酒 =====
    { jp: ['キユーピー', 'キューピー'], en: ['Kewpie'] },
    { jp: ['マルハニチロ'], en: ['Maruha Nichiro'] },
    { jp: ['ニチレイ'], en: ['Nichirei'] },
    { jp: ['永谷園'], en: ['Nagatanien'] },
    { jp: ['ミツカン'], en: ['Mizkan'] },
    { jp: ['ヤクルト'], en: ['Yakult'] },
    { jp: ['亀田製菓'], en: [] },                 // 「亀田」単体は姓/地名のため「亀田製菓」で照合
    { jp: ['不二家'], en: ['Fujiya'] },
    { jp: ['湖池屋'], en: ['Koikeya'] },
    { jp: ['井村屋'], en: ['Imuraya'] },
    { jp: ['マルコメ'], en: ['Marukome'] },
    { jp: ['ハナマルキ'], en: ['Hanamaruki'] },
    { jp: ['キーコーヒー'], en: [] },             // 「key」「coffee」一般語のためカナのみ
    { jp: ['上島珈琲'], en: ['UCC'] },          // 英字「UCC」は単語境界照合の en のみ（部分一致回避）
    { jp: ['養命酒'], en: ['Yomeishu'] },
    { jp: ['ピエトロ'], en: ['Pietro'] },
    { jp: ['桃屋'], en: ['Momoya'] },
    { jp: ['日本ハム', 'ニッポンハム'], en: [] }, // 「ハム」単体は一般語のため社名で照合
    { jp: ['伊藤ハム'], en: ['Itoham'] },
    { jp: ['プリマハム'], en: ['Prima Ham'] },
    { jp: ['月桂冠'], en: ['Gekkeikan'] },
    { jp: ['黄桜'], en: ['Kizakura'] },
    { jp: ['白鶴'], en: ['Hakutsuru'] },
    { jp: ['ブルドックソース'], en: [] },         // 「ブルドック」単体は犬種のため社名で照合
    { jp: ['オタフクソース'], en: [] },           // 「オタフク」単体は[[おたふく手袋]]と衝突するため社名で照合
    { jp: ['カンロ'], en: ['Kanro'] },
    { jp: ['UHA味覚糖', '味覚糖'], en: ['UHA'] },
    { jp: ['はくばく'], en: ['Hakubaku'] },
    { jp: ['フンドーキン'], en: ['Fundokin'] },
    { jp: ['ヒガシマル'], en: ['Higashimaru'] },

    // ===== 第14バッチ：化粧品・ヘアケア・日用品・医薬・衛生 =====
    { jp: ['久光製薬', '久光'], en: ['Hisamitsu'] },
    { jp: ['ミルボン'], en: ['Milbon'] },
    { jp: ['ちふれ'], en: ['CHIFURE'] },
    { jp: ['ホーユー'], en: ['hoyu'] },
    { jp: ['全薬工業'], en: ['Zenyaku'] },
    { jp: ['ゼリア新薬', 'ゼリア'], en: ['Zeria'] },
    { jp: ['ノエビア'], en: ['Noevir'] },
    { jp: ['バスクリン'], en: ['BATHCLIN'] },
    { jp: ['太陽油脂', 'パックスナチュロン'], en: [] },
    { jp: ['玉川衛材'], en: [] },
    { jp: ['池田模範堂'], en: [] },               // ブランド「ムヒ」は2文字で衝突するため社名で照合
    { jp: ['石澤研究所', '毛穴撫子'], en: [] },
    { jp: ['黒ばら本舗'], en: [] },
    { jp: ['オオサキメディカル'], en: [] },
    ...
    { jp: ['ミズノ'], en: ['MIZUNO'] },
    { jp: ['ヨネックス'], en: ['YONEX'] },
    { jp: ['モンベル'], en: ['mont-bell', 'montbell'] },
    { jp: ['ムーンスター'], en: ['MOONSTAR'] },
    { jp: ['ガンゾ'], en: ['GANZO'] },
    { jp: ['アニアリ'], en: ['aniary'] },
    { jp: ['ソメスサドル'], en: ['SOMES SADDLE'] },
    { jp: ['増永眼鏡'], en: ['MASUNAGA'] },       // 「マスナガ」単体は姓のため漢字社名で照合
    { jp: ['アツギ'], en: ['ATSUGI'] },
    { jp: ['ユニクロ'], en: ['UNIQLO'] },
    { jp: ['しまむら'], en: [] },                 // 「Shimamura」は姓と衝突するためカナのみ
    { jp: ['福助'], en: ['Fukuske'] },
    { jp: ['タビオ', '靴下屋'], en: ['Tabio'] },
    { jp: ['デサント'], en: ['DESCENTE'] },       // 日本企業（ルコック等の親会社）
    { jp: ['ゴールドウイン'], en: ['GOLDWIN'] },
    { jp: ['エドウィン'], en: ['EDWIN'] },
    { jp: ['ボブソン'], en: ['BOBSON'] },
    { jp: ['バートル'], en: ['BURTLE'] },
    { jp: ['ジーベック'], en: ['XEBEC'] },
    { jp: ['スコッチグレイン'], en: [] },         // 「scotch」一般語のためカナのみ
    { jp: ['ワイルドスワンズ'], en: ['WILDSWANS'] },
    { jp: ['キプリス'], en: ['CYPRIS'] },
    { jp: ['フォーナインズ'], en: [] },           // 型番「999.9」は価格等に部分一致し誤検出するためカナのみ
    { jp: ['クレドール'], en: ['CREDOR'] },
    { jp: ['ケンテックス'], en: ['Kentex'] },
    { jp: ['エバニュー'], en: ['EVERNEW'] },
    { jp: ['イグニオ'], en: ['IGNIO'] },
    { jp: ['ミキハウス'], en: ['MIKI HOUSE', 'MIKIHOUSE'] },

    // ===== 第16バッチ：文具・食器・玩具・模型・手芸・楽器 =====
    { jp: ['ノリタケ'], en: ['Noritake'] },
    { jp: ['コトブキヤ'], en: ['Kotobukiya'] },
    { jp: ['海洋堂'], en: ['Kaiyodo'] },
    { jp: ['タミヤ'], en: ['TAMIYA'] },
    { jp: ['グッドスマイルカンパニー'], en: [] }, // 「good」「smile」一般語のためカナのみ
    { jp: ['ジャノメ'], en: ['JANOME'] },         // 「蛇の目」は紋様一般語のためカナのみ
    { jp: ['野田琺瑯'], en: [] },
    { jp: ['ハマナカ'], en: ['Hamanaka'] },
    { jp: ['京商'], en: ['KYOSHO'] },
    { jp: ['藤次郎'], en: ['Tojiro'] },
    ...
    { jp: ['アガツマ'], en: ['AGATSUMA'] },
    { jp: ['ハナヤマ'], en: ['HANAYAMA'] },
    { jp: ['白山陶器'], en: [] },                 // 「HAKUSAN」は地名のため漢字社名で照合
    { jp: ['たち吉', '橘吉'], en: ['Tachikichi'] },
    { jp: ['柳宗理'], en: [] },
    { jp: ['東洋佐々木ガラス'], en: [] },         // 「佐々木」単体は姓のためフル社名で照合
    { jp: ['アデリア', '石塚硝子'], en: ['ADERIA'] },
    { jp: ['大倉陶園'], en: [] },                 // 「大倉」単体は人名/ホテルのためフル社名で照合
    { jp: ['ファインモールド'], en: [] },         // 「fine」一般語のためカナのみ
    { jp: ['ピットロード'], en: [] },             // 「pit」「road」一般語のためカナのみ

    // ===== 第17バッチ：工具・計測・カー/バイク用品・自転車・住設・ペット =====
    { jp: ['ミツトヨ'], en: ['Mitutoyo'] },
    { jp: ['カクダイ'], en: ['KAKUDAI'] },
    { jp: ['カーメイト'], en: ['CARMATE'] },
    { jp: [], en: ['PIAA'] },                     // カナ表記は稀のため英字のみ
    { jp: ['ジェックス'], en: ['GEX'] },
    { jp: ['ドギーマン', 'ドギーマンハヤシ'], en: ['DoggyMan'] },
    { jp: ['ペティオ'], en: ['Petio'] },
    { jp: ['ナカトミ'], en: ['NAKATOMI'] },
    { jp: ['ホーザン'], en: ['HOZAN'] },
    { jp: ['リングスター'], en: [] },             // 「ring」「star」一般語のためカナのみ
    { jp: [], en: ['KVK'] },                      // カナ表記は稀のため英字のみ
    { jp: ['キタコ'], en: ['KITACO'] },
    { jp: ['ワイズギア'], en: [] },               // 「Y'S GEAR」は記号含むためカナのみ
    { jp: ['ドレミコレクション'], en: [] },
    { jp: ['スエカゲツール', 'スエカゲ'], en: [] },
    { jp: ['アストロプロダクツ'], en: [] },       // 「astro」一般語のためカナのみ
    { jp: ['おたふく手袋'], en: [] },             // 「おたふく」単体は[[オタフクソース]]・一般語と衝突するためフルで照合
  ];
